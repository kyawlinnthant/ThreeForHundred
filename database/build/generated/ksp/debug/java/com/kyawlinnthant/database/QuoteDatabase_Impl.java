  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `quote` (`id` INTEGER NOT NULL, `text` TEXT NOT NULL, `author` TEXT NOT NULL, `category` TEXT NOT NULL, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '1af2bfef4bed2ba28d93f3eeb1711ad3')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsQuote = new HashMap<String, TableInfo.Column>(4);
        ...
        _columnsQuote.put("category", new TableInfo.Column("category", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoQuote.equals(_existingQuote)) {
          return new RoomOpenHelper.ValidationResult(false, "quote(com.kyawlinnthant.database.QuoteEntity).\n"
                  + " Expected:\n" + _infoQuote + "\n"
                  + " Found:\n" + _existingQuote);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "1af2bfef4bed2ba28d93f3eeb1711ad3", "5a04d3a6e29889396cf9413d8f33069a");
