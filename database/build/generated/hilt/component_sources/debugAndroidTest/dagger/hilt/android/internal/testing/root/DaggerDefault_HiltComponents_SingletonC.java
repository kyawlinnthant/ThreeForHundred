...
import com.kyawlinnthant.database.QuoteDaoTest;
import com.kyawlinnthant.database.QuoteDaoTest_MembersInjector;
import com.kyawlinnthant.database.QuoteDatabase;
import com.kyawlinnthant.database.TestDbModule;
import com.kyawlinnthant.database.TestDbModule_ProvideInMemoryDbFactory;
...
public final class DaggerDefault_HiltComponents_SingletonC {
  ...
  public static final class Builder {
     ...
     */
    @Deprecated
    public Builder testDbModule(TestDbModule testDbModule) {
      Preconditions.checkNotNull(testDbModule);
      return this;
    }
  ...
  private static final class SingletonCImpl extends Default_HiltComponents.SingletonC {
    ...
    private Provider<QuoteDatabase> provideInMemoryDbProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideInMemoryDbProvider = DoubleCheck.provider(new SwitchingProvider<QuoteDatabase>(singletonCImpl, 0));
    }

    @Override
    public void injectTest(QuoteDaoTest quoteDaoTest) {
      injectQuoteDaoTest(quoteDaoTest);
    }
    ...
    private QuoteDaoTest injectQuoteDaoTest(QuoteDaoTest instance) {
      QuoteDaoTest_MembersInjector.injectDb(instance, provideInMemoryDbProvider.get());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.kyawlinnthant.database.QuoteDatabase 
          return (T) TestDbModule_ProvideInMemoryDbFactory.provideInMemoryDb(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
